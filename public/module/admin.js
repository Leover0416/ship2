layui.define(['common', 'layer'], function (exports) {
    ...
    var admin = {
        ...
        open: function (param) {
            ...
            param.offset = param.offset ? param.offset : '280px';
        ...
        reqNoLoad: function (url, data, success, method, noHeaderToken) {
            if ('put' == method.toLowerCase()) {
                method = 'PUT';
            } else if ('delete' == method.toLowerCase()) {
                method = 'DELETE';
        ...
        reqSync: function (url, data, success, method, noHeaderToken) {
            if ('put' == method.toLowerCase()) {
                method = 'PUT';
            } else if ('delete' == method.toLowerCase()) {
                method = 'DELETE';
        ...
        reqSyncNoLoad: function (url, data, success, method, noHeaderToken) {
            if ('put' == method.toLowerCase()) {
                method = 'PUT';
            } else if ('delete' == method.toLowerCase()) {
                method = 'DELETE';
        ...
        ajax: function (param) {
            ...
            param.success = function (result, status, xhr) {
                ...
                if (jsonRs) {
                    if (jsonRs.resp_code==401||jsonRs.code == 401) {
                        config.removeToken();
...
//             var ac = 'layui-icon-screen-full', ic = 'layui-icon-screen-restore';
//             var ti = $("#fullScreen");
//             var className = ti[0].className
//       console.log(className)
//             if (className.indexOf(ac) == -1) {
//                 var ws = new ActiveXObject('WScript.Shell');
//                 ws && ws.SendKeys('{F11}');
//                 ti.addClass(ac).removeClass(ic);
//             } else {
