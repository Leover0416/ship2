    ...
    L.SVG.include({
        _updateCircle: function (layer) {
            ...
            var p = layer._map.latLngToLayerPoint(layer._latlng),
                ...
                rb = r * (layer.options.radiusb/layer.options.radius),
                rb2 = layer.options.radiusbY || rb,
                startb = p.rotated(layer.startAngle(), rb),
                endb = p.rotated(layer.stopAngle(), rb);
            ...
            //     'M' + start.x + ',' + start.y +
            //     'L' + 952 + ',' + 449 +
            //     'A ' + 10 + ',' + 10 + ',0,' + largeArc + ',1,' + 967 + ',' + 464 +
            //     'L' +  end.x + ',' + end.y +
            //     'A ' + r + ',' + r2 + ',1,' + largeArc + ',0,' + start.x + ',' + start.y +
            //     ' z';
            ...
            var d =
                ...
                'M' + start.x + ',' + start.y +
                'L' + startb.x + ',' + startb.y +
                'A ' + rb + ',' + rb2 + ',0,' + largeArc + ',1,' + endb.x + ',' + endb.y +
                'L' +  end.x + ',' + end.y +
                'A ' + r + ',' + r2 + ',1,' + largeArc + ',0,' + start.x + ',' + start.y +
                ' z';
