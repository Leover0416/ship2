...
layui.define(['common', 'admin', 'layer', 'laytpl', 'element', 'form'], function (exports) {
    var $ = layui.$;
    ...
    var index = {
        ...
        initLeftNav: function () {
            admin.reqSync('api-user/menus/current', {}, function (data) {
                //data = data[1];
        ...
        bindEvent: function () {
            ...
            $('#btnLogout').click(function () {
                layer.confirm('确定退出登录？', function () {
                    ...
                    config.removeToken();
                    location.replace('login.html');
                    //window.location = config.base_server + 'api-uaa/oauth/remove/token?redirect_uri='+config.base_server+'login.html&access_token='+accessToken;
                });
            });
            // 修改密码
